...
public class PosServiceImp implements PosService {
    ...
    //         temp.add(new Product("PD0","出错", 199, "src/assets/propictures/1.jpg",1,100,null,1.0,1,null,null));
    //         return temp;
    // }
    ...
    public List<Review> reviews(){
            return this.posDB.getReviews();
    }

    public List<Review> getSomereviews(String parent_asin){
            return this.posDB.getSomereviews(parent_asin);
    }
}