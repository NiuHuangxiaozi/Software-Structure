...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-05-09T11:28:27.488340600+08:00[Asia/Shanghai]", comments = "Generator version: 7.5.0")
public class OrderitemDto {
   ...
   */
  public OrderitemDto(String id, String name) {
    this.id = id;
    this.name = name;
  }

  public OrderitemDto id(String id) {
    this.id = id;
    return this;
  }
