...
public interface ProductsApi {
    ...
    default ResponseEntity<List<ProductDto>> listProducts(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"image\" : \"image\", \"Category\" : 6, \"quantity\" : 1, \"price\" : \"\", \"name\" : \"name\", \"id\" : \"id\", \"stock\" : 0 }, { \"image\" : \"image\", \"Category\" : 6, \"quantity\" : 1, \"price\" : \"\", \"name\" : \"name\", \"id\" : \"id\", \"stock\" : 0 } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<ProductDto> showProductById(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"image\" : \"image\", \"Category\" : 6, \"quantity\" : 1, \"price\" : \"\", \"name\" : \"name\", \"id\" : \"id\", \"stock\" : 0 }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
