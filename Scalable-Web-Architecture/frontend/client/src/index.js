...
$(document).ready(function () {
        ...
        $.get(json_api + 'products', function (data) {
            ...
            data.forEach(item => {
                ...
                let item_info = `<div class="col-lg-2 box ${item.category}"
                      ...
                      <div id="image"><img src="${item.image == "" ? "./public/images/Cola.jpg" : json_img/*img_path*/ + item.image}" id="product_img" alt=""></div>                    
  ...
  <table width="100%">
    ...
    function loadProductList() {
      ...
      <td><img style="max-height: 50px; max-width: 50px; border: 1px solid #ddd;" src="${product.image == "" ? "./public/images/Cola.jpg" : json_img/*img_path*/ + product.image}" id="product_img"></td>
      <td>${product.name}</td>
